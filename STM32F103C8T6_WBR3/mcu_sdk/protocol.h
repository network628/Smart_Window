...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "hxxgtaxsyuqfzfsu"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//充电开关(可下发可上报)
//备注:
#define DPID_CHARGE_STATE 5
//防盗提醒(可下发可上报)
//备注:
#define DPID_ANTI_THEFT 6
//开启百分比控制(可下发可上报)
//备注:
...
//自启动开关(可下发可上报)
//备注:
#define DPID_AUTO_POWER 10
//倒计时(可下发可上报)
//备注:
#define DPID_COUNTDOWN_SET 11
//倒计时剩余时间(只上报)
//备注:
#define DPID_COUNTDOWN_LEFT 12
//全程运行时间(只上报)
//备注:
...
//速度(可下发可上报)
//备注:
#define DPID_SPEED_ENUM 15
//校准(可下发可上报)
//备注:
#define DPID_CALIBRATION 16
//模式(可下发可上报)
//备注:
#define DPID_WORK_MODE 17
//开启模式(可下发可上报)
//备注:
#define DPID_OPEN_MODE 18
//工作模式延迟(可下发可上报)
//备注:
#define DPID_DELAY_TIME 19
//门窗开关(可下发可上报)
//备注:
...
//防夹开关(可下发可上报)
//备注:
#define DPID_SWITCH_ANTI_PINCH 25
//放夹力度(可下发可上报)
//备注:
#define DPID_ANTI_PINCH_STRENGTH 26
